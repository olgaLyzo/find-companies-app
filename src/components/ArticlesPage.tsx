...
const ArticlesPage: React.FC = () => {
  ...
  const documents = useSelector((state: RootState) => state.search.documents);
  const loadingDocuments = useSelector((state: RootState) => state.search.loading);
  const histograms = useSelector((state: RootState) => state.search.histograms);
  const searchStage = useSelector((state: RootState) => state.search.searchStage);
